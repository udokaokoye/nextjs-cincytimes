...
const NewsPage = () => {
  ...
  let comments = GetComments(!isLoad ? post[0]?.post_id : [], "ASC").comments;
  const history = "";
  // const getCommentUser = (userID) => {
  //   return GetUser(userID).users;
  // };
  const renderPost = isLoad ? {} : post[0];

  const pictures = isLoad ? [] : post[1];
  let newsBody;
    ...
    <>
      ...
      >
        ...
        <div className="newsPage_wrapper">
          ...
          {/* <iframe src="https://youtu.be/Rr2AU25PCuE"></iframe> */}
